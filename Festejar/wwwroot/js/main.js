(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(".gallery-popup, .gallery-popup-two").magnificPopup({ type: "image", gallery: { enabled: true } });
        $(".imgLoaded").imagesLoaded(function () {
            $(".masonry-grid").isotope({ itemSelector: ".grid-item", percentPosition: true, masonry: { columnWidth: ".grid-item" } });
        });
        ...
        $(document).on("click", ".dashboard-list .has-children a", function (e) {
            ...
            if (sh.hasClass("open")) {
                ...
                sh.siblings().find(".submenu").children(".has-children").removeClass("open");
        ...
        if (void 0 !== i && null !== i) {
            ...
            noUiSlider.create(i, { start: [j, k], connect: !0, step: n, range: { min: l, max: m } }),
        ...
        if (document.querySelector("#phone") != null) {
            ...
            window.intlTelInput(TellInput, { allowDropdown: true, excludeCountries: ["bn"] });
        }
        ...
        if (globalSlickInit.length > 0) {
            $.each(globalSlickInit, function (index, value) {
                if ($(this).children("div").length > 1) {
                    ...
                    var lazyLoad = typeof allData.lazyload == "undefined" ? false : allData.lazyload;
